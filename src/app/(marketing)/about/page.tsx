          ...
          <div className="container-wide">
            <div className="text-content flow-lg">
              ...
              <p className="text-body-lg text-fg-on-dark-subtle max-w-prose">
                I'm Nadeem Muhammed, a Digital Systems Consultant who works with service businesses
                to reduce digital friction, simplify complexity, and create systems that support
            ...
            <div className="gap-xl grid lg:grid-cols-12">
              <div className="flow lg:col-span-4">
                ...
                <h2 className="heading-lg">
                  The best results come from working with businesses that value thoughtful
                  decisions.
                </h2>
              </div>
              ...
              <div className="flow-lg text-content lg:col-span-8">
                ...
                <p className="text-subtle">
                  ...
                  genuinely supports their business. They value thoughtful decisions over quick
                  fixes and see their website as a long-term investment rather than a one-time
                  expense.
                </p>
              </div>
            </div>
          ...
          <div className="container-wide">
            ...
            <FeatureList>
              ...
              <li>
                ...
                <p>
                  Design, content, technology, and systems should all solve real business
                  problems—not exist for decoration or trend.
                </p>
              </li>
              ...
              <div className="flow-xl">
                ...
                <div className="flow-lg">
                  ...
                  <p className="text-body">
                    ...
                    Every project starts by identifying where friction exists and choosing
                    approaches that remain practical, maintainable, and valuable long after they're
                    delivered.
                  </p>
          ...
          <div className="container">
            <div className="flow-lg text-content mx-auto text-center">
              ...
              <p className="text-lg">
                ...
                clearer technology decisions, I'd love to learn about your business and explore how
                I can help.
              </p>
